...
abstract class Sleepable extends Transparent implements HorizontalFacing
{
	...
	/** @return static|null */
	public function getOtherHalf() : ?Sleepable
	{
		$other = $this->getSide($this->getOtherHalfSide());
		if ($other instanceof static && $other->head !== $this->head && $other->facing === $this->facing) {
			return $other;
		}
		return null;
	}
